...
const Country = ({ country }) => {
  ...
  return (
    <div className='py-3'>
      <div className='lg:h-[425px] flex flex-col items-center justify-center border border-teal-500 rounded-md p-4 space-y-2'>
        ...
        <button
          ...
          className='border border-stone-500 px-4 py-2 rounded-md hover:bg-gray-600 transition-all'
        >
