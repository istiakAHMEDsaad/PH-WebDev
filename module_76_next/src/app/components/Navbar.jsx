        ...
        <ul className='flex gap-2'>
          ...
          <li>
            <Link
              href={'/shop'}
              className={
                `block border border-gray-400 rounded-md py-1 px-4 hover:bg-black/95 hover:text-white transition-colors cursor-pointer ${isActive('/shop')}`
              }
            >
              Shop
            </Link>
          ...
          <li>
            <Link
              href={'/about'}
              className={
                `block border border-gray-400 rounded-md py-1 px-4 hover:bg-black/95 hover:text-white transition-colors cursor-pointer ${isActive('/about')}`
              }
            >
              About
            </Link>
          ...
          <li>
            <Link
              href={'/contact'}
              className={
                `block border border-gray-400 rounded-md py-1 px-4 hover:bg-black/95 hover:text-white transition-colors cursor-pointer ${isActive('/contact')}`
              }
            >
              Contact
            </Link>
